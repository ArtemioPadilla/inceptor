---
title: "0004 — Custom /docs route over Astro Starlight"
...
The earlier docs-site decision recorded as
[0003 — Astro Starlight for the docs site](./0003-starlight-for-docs) chose
Astro Starlight v0.37 mounted at `/docs/*` to fix the F5 documentation-friction
...
[0003 — Astro Starlight for the docs site](./0003-starlight-for-docs). Starlight
was never shipped; this route replaces it.

## References

- `ROADMAP.md` Epic 15 — Docs site (custom `/docs/*` route)
