---
title: "0003 — Centinela verdict tokens for orchestrator routing"
...
twice" lessons-learned trigger (ADR 0001).
...
- `ROADMAP.md` Epic 14 — Centinela verdict tokens
- ADR 0001 — lessons-learned rejection trigger
