---
title: "0005 — Base UI as the standard component library"
...
ADR [0002](./0002-base-ui-over-radix) settled the *primitive layer*: Base UI
...
out of scope — is maintained in `docs/component-catalog.md` and rendered live at
`/gallery`.
...
None — extends ADR [0002](./0002-base-ui-over-radix) from the primitive layer to
the whole library.

## References

- `docs/component-catalog.md` — full inventory and coverage scorecard
- ADR [0002](./0002-base-ui-over-radix) — Base UI over Radix for primitives
- `ROADMAP.md` Epic 16 — Gallery + Demo surface
